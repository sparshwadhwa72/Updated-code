...
const ManagePbarSto = ({ page }) => {
  ...
  return (
    ...
    margin: '0px 0px 0px 1px',}}  >
          <div className={page === 1 ? classes.currentProgbar : classes.currentProgbar}></div>
        </Grid>
      </Grid>
      <Grid item>
          <Typography style={{
    ...
    }}className={page === 2 ? classes.currentText : classes.currentText}>
            Schedule
          </Typography>
    ...
    margin: '0px 0px 0px 83px',
          ...
          <div 
            className={
              page === 3
                ? `${classes.currentProgbar} ${classes.progbarRight}`
                : `${classes.currentProgbar} ${classes.progbarRight}`
            }
          ></div>
        </Grid>
    ...
    }} className={page === 3 ? classes.currentText : classes.currentText}>
            Storage
          </Typography>
